...
# @app.route('/api/get_student_id_by_bedtime_preference/')
def get_student_id_by_bedtime_preference(gender, bedtime_preference):
    ...
    print(f'Students with bedtime {bedtime_preference}:\n\nStudent_id | Name\n\n')
...
# @app.route('/api/get_student_id_by_ac_fan_preference/')
...
# @app.route('/api/get_student_id_by_ac_preference_fan_preference/')
...
# @app.route('/api/select_roommate_preference/')
...
#get_student_ids_by_gender('F')
#get_student_id_by_bedtime_preference('M', 23)
